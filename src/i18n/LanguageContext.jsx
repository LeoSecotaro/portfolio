...
const translations = {
  ...
  en: {
    ...
    common: { viewDetails: 'View details', closePreview: 'Close preview', technologies: 'Technologies & Tools', keyFeatures: 'Key Features & Implementation', architecture: 'Architecture Summary', impact: 'Impact & Key Metric', level: 'Proficiency Level', downloadPdf: 'Download PDF', linkedin: 'LinkedIn Profile', email: 'Email', phone: 'Phone / WhatsApp', cvTitle: 'Unified Curriculum Vitae', cvDescription: 'Download the print-ready PDF version.', university: 'University', core: 'Core Specialty', general: 'Overview', philosophy: 'Philosophy & Soft Skills', languages: 'Languages & Certifications', academicProject: 'Academic Project', backToTop: 'Back to top', informationSystemsEngineer: 'Information Systems Engineer (UTN)', courseTools: 'Tools', courseLearning: 'Course content' },
