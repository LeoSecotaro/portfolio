...
const translations = {
  es: {
    nav: { home: 'Inicio', profile: 'Perfil', experience: 'Experiencia', projects: 'Proyectos', skills: 'Habilidades', education: 'Educación', contact: 'Contacto', terminal: 'Terminal', download: 'Descargar CV', menu: 'Abrir menú', language: 'Cambiar idioma' },
    hero: {
      headlineFirst: 'Leonardo Tomás', headlineLast: 'Secotaro Ianardi', title: 'Ingeniero en Sistemas de Información especializado en desarrollo', data: 'Ingeniería de Datos & RAG', security: 'Infraestructura SOC', description: 'Especialista en construir soluciones integrales con Python, Ruby on Rails y React.js, diseñando desde pipelines ETL automatizados con Airflow hasta modelos de lenguaje acoplados a grafos (Neo4j).', projects: 'Explorar Proyectos', contact: 'Contactar', profile: 'Perfil profesional', location: 'UTN ISI · Mendoza', degree: 'Título UTN ISI', metricDegree: 'UTN ISI Carrera Finalizada', metricRecords: 'Registros ETL Airflow', metricModels: 'Modelos de Grafos & LLM', metricSoc: 'TryHackMe Ciberseguridad'
    },
    section: {
      pillarsEyebrow: 'Pilares Tecnológicos', pillarsTitle: 'Soluciones de extremo a extremo con precisión de ingeniería', pillarsDescription: 'Especialización práctica articulando desde la infraestructura de redes y seguridad hasta pipelines de IA generativa y frontends interactivos.',
  ...
  en: {
    nav: { home: 'Home', profile: 'Profile', experience: 'Experience', projects: 'Projects', skills: 'Skills', education: 'Education', contact: 'Contact', terminal: 'Terminal', download: 'Download CV', menu: 'Open menu', language: 'Change language' },
    hero: {
    ...
    common: { viewDetails: 'View Details', closePreview: 'Close Preview', technologies: 'Technologies & Tools', keyFeatures: 'Key Features & Implementation', architecture: 'Architecture Summary', impact: 'Impact & Key Metric', level: 'Proficiency Level', downloadPdf: 'Download PDF', linkedin: 'LinkedIn Profile', email: 'Email', phone: 'Phone / WhatsApp', cvTitle: 'Unified Curriculum Vitae', cvDescription: 'Download the print-ready PDF version.', university: 'University', core: 'Core Specialty', general: 'Overview', philosophy: 'Philosophy & Soft Skills', languages: 'Languages & Certifications', academicProject: 'Academic Project', backToTop: 'Back to top', informationSystemsEngineer: 'Information Systems Engineer (UTN)' },
